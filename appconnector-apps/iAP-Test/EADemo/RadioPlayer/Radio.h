...
#include "Queue.h"
#include "Packet.h"
#include "EADSessionTransferViewController.h"
...
@interface Radio : NSObject {
	...
	int attemptCount;
	UIAlertView *alert;
	EADSessionTransferViewController *appDelegate;
	AQPlayerState audioState;
}

-(id)init;
-(BOOL)connect:(NSString *)loc withDelegate:(EADSessionTransferViewController*)delegate withGain:(float)gain;
