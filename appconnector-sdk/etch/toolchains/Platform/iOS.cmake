...
# IOS_ARCH should be defined by toolchain file.
if (NOT DEFINED IOS_ARCH)
    MESSAGE(FATAL_ERROR "IOS_ARCH is not defined. Please use proper toolchain with IOS_ARCH definition.")
endif (NOT DEFINED IOS_ARCH)
set (IOS_ARCH ${IOS_ARCH} CACHE STRING "Type of iOS ARCH")

# Check the platform selection and setup for developer root
if (${IOS_PLATFORM} STREQUAL "DEVICE")
	set (IOS_PLATFORM_LOCATION "iPhoneOS.platform")
	set (IOS_TARGET_ARCH ${IOS_ARCH})
